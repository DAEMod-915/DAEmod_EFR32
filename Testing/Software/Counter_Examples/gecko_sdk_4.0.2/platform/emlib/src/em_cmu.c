...
static void
lcdClkGet (uint32_t *freq, CMU_Select_TypeDef *sel);
#endif
...
static void
lesenseHFClkGet (uint32_t *freq, CMU_Select_TypeDef *sel);
#endif
    ...
    case cmuClock_SYSTICK:
      switch (ref)
        ...
        case cmuSelect_ULFRCO:
          ...
          SYSCFG->CFGSYSTIC = (SYSCFG->CFGSYSTIC
...
// -----------------------------------------------------------------------------
    ...
    case cmuClock_LCDCLK:
      ...
      CMU->LCDCLKCTRL = (CMU->LCDCLKCTRL & ~_CMU_LCDCLKCTRL_CLKSEL_MASK) | tmp;
      break;
#endif
// -----------------------------------------------------------------------------
#if defined(VDAC_PRESENT)
...
// -----------------------------------------------------------------------------
    ...
    case cmuClock_LESENSEHFCLK:
      ...
      CMU->LESENSEHFCLKCTRL = (CMU->LESENSEHFCLKCTRL
          & ~_CMU_LESENSEHFCLKCTRL_CLKSEL_MASK) | tmp;
      break;
#endif
// -----------------------------------------------------------------------------
#if defined(USB_PRESENT)
...
CMU_HFXOInit (const CMU_HFXOInit_TypeDef *hfxoInit)
{
  ...
  BUS_RegMaskedWrite ((volatile uint32_t*) (HFXO0_BASE + 0x38U), 0x00000C00UL,
                      0x00000002UL << 10);
#endif
      ...
      if (hfxoInit->mode == cmuHfxoOscMode_ExternalSinePkDet)
        {
          ...
          BUS_RegMaskedWrite (
              (volatile uint32_t*) (HFXO0_BASE + 0x34UL),
...
#endif
      ret =
          (LFRCO->CAL & _LFRCO_CAL_FREQTRIM_MASK) >> _LFRCO_CAL_FREQTRIM_SHIFT;
      break;
#endif
