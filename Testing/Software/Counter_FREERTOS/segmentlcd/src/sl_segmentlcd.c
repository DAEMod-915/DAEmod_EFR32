...
#define NUM_DIGITS              5
#define NUM_VAL_MAX             99999
#define NUM_VAL_MIN             -9999
#define NUM_VAL_MAX_HEX         0xFFFFF
#else
#define NUM_DIGITS              4
...
void SegmentLCD_Symbol(lcdSymbol s, int on)
{
  ...
  switch (s) {
    ...
    case LCD_SYMBOL_S14:
      ...
      break;
#endif
#ifdef LCD_SYMBOL_P2_SEG
    case LCD_SYMBOL_P2:
      com = LCD_SYMBOL_P2_COM;
      bit = LCD_SYMBOL_P2_SEG;
      break;
#endif
#ifdef LCD_SYMBOL_P3_SEG
    case LCD_SYMBOL_P3:
      com = LCD_SYMBOL_P3_COM;
      bit = LCD_SYMBOL_P3_SEG;
      break;
#endif
#ifdef LCD_SYMBOL_P4_SEG
    case LCD_SYMBOL_P4:
      com = LCD_SYMBOL_P4_COM;
      bit = LCD_SYMBOL_P4_SEG;
      break;
#endif
#ifdef LCD_SYMBOL_P5_SEG
    case LCD_SYMBOL_P5:
      com = LCD_SYMBOL_P5_COM;
      bit = LCD_SYMBOL_P5_SEG;
      break;
#endif
#ifdef LCD_SYMBOL_P6_SEG
    case LCD_SYMBOL_P6:
      com = LCD_SYMBOL_P6_COM;
      bit = LCD_SYMBOL_P6_SEG;
      break;
#endif
    default:
      break;
...
#else
  segdl = LCD->SEGD0;
  segCnt = SegmentLCD_segCnt(segdl, 0);
#endif
