...
#define EFM_DISPLAY_DEF {                                         \
    .Number      = {                                              \
      ...
      { /* #2 location : Segments 2A/2B/2C/2D/2E/2F/2G */         \
        .com[0] = 3, .com[1] = 3, .com[2] = 1, .com[3] = 0,       \
        .bit[0] = 2, .bit[1] = 3, .bit[2] = 3, .bit[3] = 2,       \
        .com[4] = 1, .com[5] = 2, .com[6] = 2,                    \
        .bit[4] = 2, .bit[5] = 2, .bit[6] = 3,                    \
      },                                                          \
